        ...
        $('body').on('show.bs.dropdown', function(t) {
          ...
          if (0 !== e.length) {
            ...
            e.data('dropdown-menu', a),
              $('body').append(a),
              a.css('display', 'block'),
              a.position({my: 'right top', at: 'right bottom', of: $(t.relatedTarget)});
          }
        }),
          ...
          $('body')
            .on('show.bs.dropdown', t, function(t) {
              (e = $(t.target).find('.dropdown-menu')),
                ...
                e.css('display', 'block'),
                e.position({my: 'right top', at: 'right bottom', of: $(t.relatedTarget)});
            })
...
'undefined' != typeof module && void 0 !== module.exports && (module.exports = KTApp),
  $(document).ready(function() {
    /*Initialize KTApp in angular component KTApp.init(KTAppOptions)*/
  });
    ...
    var o = {},
      i = {
        construct: function(t) {
          return (
            KTUtil.data(n).has('avatar') ? (a = KTUtil.data(n).get('avatar')) : (i.init(t), i.build(), KTUtil.data(n).set('avatar', a)), a
          );
        },
        init: function(t) {
          (a.element = n),
  ...
  if (void 0 !== n) {
    var i = {classic: !1, offset: {mobile: 150, desktop: 200}, minimize: {mobile: !1, desktop: !1}},
      l = {
        construct: function(t) {
          return (
            KTUtil.data(n).has('header') ? (a = KTUtil.data(n).get('header')) : (l.init(t), l.build(), KTUtil.data(n).set('header', a)), a
          );
        },
        init: function(t) {
            ...
            window.addEventListener('scroll', function() {
              ...
              KTUtil.isInResponsiveRange('desktop')
                ...
                : KTUtil.isInResponsiveRange('tablet-and-mobile') &&
                  ((s = a.options.offset.mobile), (n = a.options.minimize.mobile.on), (i = a.options.minimize.mobile.off)),
                (r = KTUtil.getScrollTop()),
                (KTUtil.isInResponsiveRange('tablet-and-mobile') && a.options.classic && a.options.classic.mobile) ||
                (KTUtil.isInResponsiveRange('desktop') && a.options.classic && a.options.classic.desktop)
                  ? r > s
      ...
      r = {
        construct: function(t) {
          return (
            KTUtil.data(o).has('menu')
              ...
              : (r.init(t), r.reset(), r.build(), KTUtil.data(o).set('menu', a)),
            a
          );
        },
        init: function(t) {
        ...
        handleSubmenuDrodownHoverEnter: function(t) {
          if ('accordion' !== r.getSubmenuMode(this) && !1 !== a.resumeDropdownHover()) {
            '1' == this.getAttribute('data-hover') &&
              (this.removeAttribute('data-hover'), clearTimeout(this.getAttribute('data-timeout')), this.removeAttribute('data-timeout')),
        ...
        hideSubmenuDropdown: function(t, e) {
          e && (KTUtil.removeClass(t, 'kt-menu__item--hover'), KTUtil.removeClass(t, 'kt-menu__item--active-tab')),
            ...
            t.getAttribute('data-ktmenu-dropdown-toggle-class') &&
              KTUtil.removeClass(i, t.getAttribute('data-ktmenu-dropdown-toggle-class'));
        ...
        showSubmenuDropdown: function(t) {
          ...
          KTUtil.addClass(t, 'kt-menu__item--hover'),
            t.getAttribute('data-ktmenu-dropdown-toggle-class') && KTUtil.addClass(i, t.getAttribute('data-ktmenu-dropdown-toggle-class'));
        },
  ...
  if (n) {
    var i = {
      ...
      l = {
        construct: function(t) {
          return (
            KTUtil.data(n).has('portlet') ? (a = KTUtil.data(n).get('portlet')) : (l.init(t), l.build(), KTUtil.data(n).set('portlet', a)),
            a
          );
        },
        init: function(t) {
          (a.element = n),
            ...
            KTUtil.child(n, '.kt-portlet__body')
              ...
              : KTUtil.child(n, '.kt-form') && (a.body = KTUtil.child(n, '.kt-form'));
        },
        build: function() {
        ...
        remove: function() {
          !1 !== l.eventTrigger('beforeRemove') &&
            (KTUtil.hasClass(o, 'kt-portlet--fullscreen') && KTUtil.hasClass(n, 'kt-portlet--fullscreen') && l.fullscreen('off'),
            l.removeTooltips(),
            KTUtil.remove(n),
  ...
  if (n) {
    var o = {togglerState: '', targetState: ''},
      i = {
        construct: function(t) {
          return (
            KTUtil.data(n).has('toggle') ? (a = KTUtil.data(n).get('toggle')) : (i.init(t), i.build(), KTUtil.data(n).set('toggle', a)), a
          );
        },
        init: function(t) {
          (a.element = n),
  ...
  return {
    ...
    getHighestZindex: function(t) {
      for (var e, a, n = KTUtil.get(t); n && n !== document; ) {
        if (
          ('absolute' === (e = KTUtil.css(n, 'position')) || 'relative' === e || 'fixed' === e) &&
    ...
    triggerCustomEvent: function(t, e, a) {
      var n;
      window.CustomEvent ? (n = new CustomEvent(e, {detail: a})) : (n = document.createEvent('CustomEvent')).initCustomEvent(e, !0, !0, a),
        t.dispatchEvent(n);
    },
          ...
          has: function(e) {
            return (
              ...
              null != t &&
                ...
                !(!window.KTUtilElementDataStore[t.customDataTag] || !window.KTUtilElementDataStore[t.customDataTag][e])
            );
          },
          remove: function(e) {
    ...
    offset: function(t) {
      ...
      if ((t = KTUtil.get(t)))
        return t.getClientRects().length
          ? ((e = t.getBoundingClientRect()), (a = t.ownerDocument.defaultView), {top: e.top + a.pageYOffset, left: e.left + a.pageXOffset})
          : {top: 0, left: 0};
    },
    height: function(t) {
      ...
      if (!(!t || ('up' == e && !1 === KTUtil.visible(t)) || ('down' == e && !0 === KTUtil.visible(t)))) {
        ...
        KTUtil.css(t, 'padding-top') &&
          ...
          KTUtil.css(t, 'padding-bottom') &&
            ...
            KTUtil.data(t).set('slide-padding-bottom', KTUtil.css(t, 'padding-bottom')),
    ...
    off: function(t, e, a) {
      t &&
        ...
        (KTUtil.removeEvent(t, e, window.KTUtilDelegatedEventHandlers[a]), delete window.KTUtilDelegatedEventHandlers[a]);
    },
    one: function(t, e, a) {
        ...
        if (
          ...
          (a = KTUtil.data(t).get('ps'))
            ? (e.resetHeightOnDestroy
                ...
                : (KTUtil.css(t, 'overflow', 'auto'), n > 0 && KTUtil.css(t, 'height', n + 'px')),
              a.destroy(),
  ...
  if (n) {
    var o = {startStep: 1, clickableSteps: !0},
      i = {
        construct: function(t) {
          return (
            KTUtil.data(n).has('wizard') ? (a = KTUtil.data(n).get('wizard')) : (i.init(t), i.build(), KTUtil.data(n).set('wizard', a)), a
          );
        },
        init: function(t) {
          (a.element = n),
        ...
        goTo: function(t, e) {
          if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
            ...
            if (
              ...
              !0 === e && (n = t > a.currentStep ? i.eventTrigger('beforeNext') : i.eventTrigger('beforePrev')),
              !0 !== a.stopped)
            )
              return (
                !1 !== n &&
                  (!0 === e && i.eventTrigger('beforeChange'), (a.currentStep = t), i.updateUI(), !0 === e && i.eventTrigger('change')),
        ...
        var l = {
          ...
          init: function(e) {
            ...
            null === e.data.source && (l.extractTable(), (n = !0)),
              ...
              ('remote' !== e.data.type && 'local' !== e.data.type) ||
                ((!1 === e.data.saveState || (!1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage)) &&
                  l.stateRemove(l.stateId),
                'local' === e.data.type &&
                  'object' == typeof e.data.source &&
                  (i.dataSet = i.originalDataSet = l.dataMapCallback(e.data.source)),
                l.dataRender()),
              n &&
                (t(i.tableHead)
                  .find('tr')
              ...
              (null !== e.data.type && 'local' !== e.data.type) ||
                (l.setupCellField.call(), l.setupTemplateCell.call(), l.setupSubDatatable.call(), l.setupSystemColumn.call(), l.redraw());
            var o = !1;
          ...
          layoutUpdate: function() {
            l.setupSubDatatable.call(),
              ...
              l.scrollbar.call(),
              l.isInit ||
                (l.dropdownFix(), t(i).trigger('kt-datatable--on-init', {table: t(i.wrap).attr('id'), options: o}), (l.isInit = !0)),
                              ...
                              .each(function() {
                                ...
                                t(this)
                                  ...
                                  .each(function() {
                                    ...
                                    void 0 !== n
                                      ? ((void 0 === n.left && !0 !== n) || t(this).appendTo(e), void 0 !== n.right && t(this).appendTo(i))
                                      : t(this).appendTo(a);
                                  }),
                                  t(this).remove();
                              }),
          ...
          fullRender: function() {
            t(i.tableHead).empty(),
              l.setHeadTitle(),
              l.getOption('layout.footer') && (t(i.tableFoot).empty(), l.setHeadTitle(i.tableFoot)),
              l.spinnerCallback(!0),
          ...
          lockEnabledColumns: function() {
            ...
            return (
              t.each(n, function(t, n) {
                void 0 !== n.locked &&
                  (void 0 !== n.locked.left && a.getBreakpoint(n.locked.left) <= e && i.left.push(n.locked.left),
                  void 0 !== n.locked.right && a.getBreakpoint(n.locked.right) <= e && i.right.push(n.locked.right));
              }),
              i
            );
          },
          ...
          setupBaseDOM: function() {
            (i.initialDatatable = t(i).clone()),
              ...
              void 0 !== o.layout.footer &&
                o.layout.footer &&
                ((i.tableFoot = t(i.table).find('tfoot')), 0 === t(i.tableFoot).length && (i.tableFoot = t('<tfoot/>').appendTo(i.table)));
          },
                ...
                if (o.layout.scroll) {
                  ...
                  t(r).find('.kt-datatable__row').length > 0 && t(r).length > 0
                    ? ((e.scrollHead = t(i.tableHead).find('> .kt-datatable__lock--scroll > .kt-datatable__row')),
                      ...
                      l.getOption('layout.customScrollbar') && 10 != a.detectIE() && n > a.getBreakpoint('lg')
          ...
          updateTableComponents: function() {
            (i.tableHead = t(i.table)
              .children('thead')
              .get(0)),
              (i.tableBody = t(i.table)
                .children('tbody')
                .get(0)),
              (i.tableFoot = t(i.table)
                .children('tfoot')
                .get(0));
          },
          getData: function() {
              ...
              populate: function() {
                ...
                (o.pagerLayout.pagination = n),
                  t('<li/>')
                    .append(
                      t('<a/>')
                        .attr('title', a.first)
                        .addClass('kt-datatable__pager-link kt-datatable__pager-link--first')
                  ...
                  t('<li/>')
                    .append(
                      t('<a/>')
                        .attr('title', a.prev)
                        .addClass('kt-datatable__pager-link kt-datatable__pager-link--prev')
                  ...
                  t('<li/>')
                    .append(
                      t('<a/>')
                        .attr('title', a.more)
                        .addClass('kt-datatable__pager-link kt-datatable__pager-link--more-prev')
                ...
                for (var c = d; c < s; c++) {
                  ...
                  t('<li/>')
                    .append(
                      t('<a/>')
                        .addClass('kt-datatable__pager-link kt-datatable__pager-link-number')
                        .text(u)
                        .attr('data-page', u)
                        .attr('title', u)
                        .on('click', o.gotoPage)
                ...
                t('<li/>')
                  .append(
                    t('<a/>')
                      .attr('title', a.more)
                      .addClass('kt-datatable__pager-link kt-datatable__pager-link--more-next')
                      .html(t('<i/>').addClass(e.more))
                      .on('click', o.gotoMorePage)
                  )
                  .appendTo(n),
                  t('<li/>')
                    .append(
                      t('<a/>')
                        .attr('title', a.next)
                        .addClass('kt-datatable__pager-link kt-datatable__pager-link--next')
                  ...
                  t('<li/>')
                    .append(
                      t('<a/>')
                        .attr('title', a.last)
                        .addClass('kt-datatable__pager-link kt-datatable__pager-link--last')
                  ...
                  l.getOption('toolbar.items.info') &&
                    (o.pagerLayout.info = t('<div/>')
                      ...
                      .append(t('<span/>').addClass('kt-datatable__pager-detail'))),
              ...
              if (void 0 !== o.responsive || void 0 !== o.visible) {
                ...
                setTimeout(function() {
                  !1 === l.getObject('visible', o)
                    ? t(s).hide()
                    : (a.getBreakpoint(l.getObject('responsive.hidden', o)) >= e ? t(s).hide() : t(s).show(),
                      a.getBreakpoint(l.getObject('responsive.visible', o)) <= e ? t(s).show() : t(s).hide());
                });
              }
            });
          },
          setupSubDatatable: function() {
            ...
            if ('function' == typeof e && !(t(i.table).find('.kt-datatable__subtable').length > 0)) {
              ...
              var a = function(a) {
                  ...
                  0 === t(r).length &&
                    ((r = t('<tr/>')
                      .addClass('kt-datatable__row-subtable kt-datatable__row-loading')
                      .hide()
                      .append(
                        t('<td/>')
                  ...
                  t(n).hasClass('kt-datatable__row--subtable-expanded')
                    ? (t(c).addClass(l.getOption('layout.icons.rowDetail.collapse')),
                      t(n).removeClass('kt-datatable__row--subtable-expanded'),
                      t(i).trigger('kt-datatable--on-collapse-subtable', [n]))
                    : (t(c).addClass(l.getOption('layout.icons.rowDetail.expand')),
          ...
          spinnerCallback: function(t, e) {
            ...
            void 0 !== a &&
              ...
              (t
                ? l.isSpinning ||
                  (void 0 !== a.message && !0 === a.message && (a.message = l.getOption('translate.records.processing')),
                  (l.isSpinning = !0),
              ...
              switch (o) {
                ...
                case 'html':
                  return t(e).sort(function(e, n) {
                    return (
                      (s = t(e[l]).text()), (d = t(n[l]).text()), 'asc' === a ? (s > d ? 1 : s < d ? -1 : 0) : s < d ? 1 : s > d ? -1 : 0
                    );
                  });
                case 'string':
                default:
                ...
                t(i.tableBody).each(function() {
                  for (var a = 0; t(this)[0].offsetWidth < t(this)[0].scrollWidth && a < o.columns.length; )
                    t(i.table)
                      ...
                      .each(function(a) {
                        var n = t(this)
                          .find('.kt-datatable__cell:not(:hidden):not([data-autohide-disabled])')
                          .last();
                        t(n).hide(), (e = !0);
                      }),
                      a++;
          ...
          getExtraSpace: function(e) {
            return (
              ...
              (parseInt(t(e).css('marginRight')) + parseInt(t(e).css('marginLeft'))) +
              Math.ceil(
                t(e)
          ...
          stateKeep: function(t, e) {
            (t = l.getTablePrefix(t)),
              !1 !== l.getOption('data.saveState') &&
                (l.getOption('data.saveState.webstorage') && localStorage && localStorage.setItem(t, JSON.stringify(e)),
          ...
          stateGet: function(t, e) {
            if (((t = l.getTablePrefix(t)), !1 !== l.getOption('data.saveState'))) {
              var a = null;
              return null != (a = l.getOption('data.saveState.webstorage') && localStorage ? localStorage.getItem(t) : Cookies.get(t))
                ? JSON.parse(a)
                : void 0;
            }
          },
          ...
          localDataUpdate: function() {
            ...
            if (
              ...
              void 0 !== s &&
                '' !== s &&
                ((s = s.toLowerCase()), (i.dataSet = t.grep(i.dataSet, r)), delete e.query[l.getGeneralSearchKey()]),
          ...
          rowEvenOdd: function() {
            t(i.tableBody)
              ...
              t(i.wrap).hasClass('kt-datatable--subtable')
                ? t(i.tableBody)
                    .find('.kt-datatable__row:not(.kt-datatable__row-detail):even')
          ...
          redraw: function() {
            return (
              l.adjustCellsWidth.call(),
              l.isLocked() && (l.scrollbar(), l.resetScroll(), l.adjustCellsHeight.call()),
          ...
          setActive: function(e) {
            'string' == typeof e && (e = t(i.tableBody).find('.kt-checkbox--single > [type="checkbox"][value="' + e + '"]')),
              t(e).prop('checked', !0);
            var a = [];
          ...
          setDataSourceParam: function(e, a) {
            (i.API.params = t.extend(
              {},
              {pagination: {page: 1, perpage: l.getOption('data.pageSize')}, sort: l.getDefaultSortColumn(), query: {}},
              i.API.params,
            ...
            if (t(l.recentNode.length)) {
              ...
              if (l.recentNode === l.nodeCols) {
                ...
                if (l.isLocked()) {
                  ...
                  i
                    ? (n += a.left.length + 1)
                    : t(l.recentNode).closest('.kt-datatable__lock--right').length && (n += a.left.length + i + 1);
                }
              }
              e
                ? (l.recentNode === l.nodeCols && delete o.columns[n].visible, t(l.recentNode).show())
                : (l.recentNode === l.nodeCols && l.setOption('columns.' + n + '.visible', !1), t(l.recentNode).hide()),
                l.columnHide(),
                l.redraw();
            }
          },
            ...
            t(e.tableHead)
              ...
              t(e.tableBody)
                ...
                .click(function(o) {
                  var i = t(this).val();
                  t(this).is(':checked')
                    ? (n.selectedRows.push(i), (n.unselectedRows = n.remove(n.unselectedRows, i)))
                    : (n.unselectedRows.push(i), (n.selectedRows = n.remove(n.selectedRows, i))),
                    !a.vars.requestIds &&
...
KTUtil.isRTL() &&
  (defaults = {
    layout: {
      icons: {
        pagination: {next: 'flaticon2-back', prev: 'flaticon2-next', first: 'flaticon2-fast-next', last: 'flaticon2-fast-back'},
  ...
  var t,
    ...
    r = function(t) {
      ...
      return (
        ...
        KTUtil.isInResponsiveRange('desktop')
          ? (e -= KTUtil.actualHeight(KTUtil.get('kt_header')))
          : (e -= KTUtil.actualHeight(KTUtil.get('kt_header_mobile'))),
        e
      );
    };
  return {
    init: function() {
      $('#kt_aside_secondary_nav a[data-toggle="tab"]').on('click', function(e) {
        t && t.is($(this)) && $('body').hasClass('kt-aside-secondary--expanded')
          ? KTLayout.closeAsideSecondary()
          : ((t = $(this)), KTLayout.openAsideSecondary());
      }),
                ...
                KTUtil.isInResponsiveRange('desktop')
                  ? (KTUtil.hasClass(t, 'kt-header--fixed') && (e += parseInt(KTUtil.css(KTUtil.get('kt_header'), 'height'))),
                    KTUtil.hasClass(t, 'kt-subheader--fixed') &&
                      ...
                      (e += parseInt(KTUtil.css(KTUtil.get('kt_subheader'), 'height'))))
  ...
  return {
    ...
    initHeader: function() {
      ...
      (n = KTUtil.get('kt_header')),
        (t = KTUtil.attr(n, 'data-ktheader-minimize-offset')) && (options.offset.desktop = t),
        (t = KTUtil.attr(n, 'data-ktheader-minimize-mobile-offset')) && (options.offset.mobile = t),
    ...
    initAside: function() {
      ...
      (s = KTUtil.get('kt_aside')),
        ...
        (p = '1' === KTUtil.attr(u, 'data-ktmenu-dropdown') ? 'dropdown' : 'accordion'),
            ...
            height: function() {
              ...
              return (
                (t = KTUtil.isInResponsiveRange('desktop')
                  ...
                  : parseInt(KTUtil.getViewPort().height) -
                    parseInt(KTUtil.getByID('kt_aside_footer') ? KTUtil.actualHeight('kt_aside_footer') : 0)),
                (t -= parseInt(KTUtil.css(u, 'marginBottom')) + parseInt(KTUtil.css(u, 'marginTop')))
              );
            }
          }),
    ...
    initAsideSecondary: function() {
      KTUtil.get('kt_aside_secondary') &&
        (l = new KTToggle('kt_aside_secondary_toggler', {target: 'body', targetState: 'kt-aside-secondary--expanded'})).on(
          'toggle',
          function(e) {
            KTUtil.transitionEnd(t, function() {
    ...
    if (0 != t.length) {
      ...
      var l = {
        ...
        options: {
          ...
          hover: {mode: 'index'},
          scales: {
            xAxes: [{display: !1, gridLines: !1, scaleLabel: {display: !1, labelString: 'Month'}}],
            yAxes: [{display: !1, gridLines: !1, scaleLabel: {display: !1, labelString: 'Month'}}]
          },
              ...
              yAxes: [
                {
                  ...
                  gridLines: {color: '#eef2f9', drawBorder: !1, offsetGridLines: !0, drawTicks: !1},
                  ticks: {max: a, display: !1, beginAtZero: !0}
                }
              ]
            },
      ...
      !(function() {
        ...
        KTUtil.scrollInit(a, {
          ...
          height: function() {
            ...
            return (
              e && ((a -= parseInt(KTUtil.actualHeight(e))), (a -= parseInt(KTUtil.css(e, 'marginBottom')))),
        ...
        (function() {
          ...
          KTUtil.scrollInit(a, {
            ...
            height: function() {
              var a = parseInt(KTUtil.getViewPort().height);
              return (
                t && ((a -= parseInt(KTUtil.actualHeight(t))), (a -= parseInt(KTUtil.css(t, 'marginBottom')))),
  ...
  var t = KTUtil.get('kt_quick_panel'),
    ...
    o = function() {
      ...
      return (
        ...
        parseInt(KTUtil.css(e, 'margin-bottom')) -
            ...
            $.ajax({
              ...
              error: function(e) {
                (d = !1),
                  g(),
                  KTUtil.addClass(t, f),
                  KTUtil.setHTML(o, '<span class="kt-quick-search__message">Connection error. Pleae try again later.</div>'),
                  h(),
